...
class RookTest extends Specification {
    ...
    def "Rook valid/invalid move testing"() {
        ...
        // left
        new Moves(4, 3, 4, 2) | true
        new Moves(4, 3, 4, 1) | true
        new Moves(4, 3, 4, 0) | true
        // right
        new Moves(4, 3, 4, 4) | true
        new Moves(4, 3, 4, 5) | true
        new Moves(4, 3, 4, 6) | true
        new Moves(4, 3, 4, 7) | true
        // up
        new Moves(4, 3, 3, 3) | true
        new Moves(4, 3, 2, 3) | true
        new Moves(4, 3, 1, 3) | true
        // down
        new Moves(4, 3, 5, 3) | true
        new Moves(4, 3, 6, 3) | true
        new Moves(4, 3, 1, 3) | true
        // non valid moves
        new Moves(4, 3, 7, 3) | false
        new Moves(4, 3, 0, 3) | false
        new Moves(4, 3, 3, 1) | false
        new Moves(4, 3, 3, 6) | false
        new Moves(4, 3, 5, 2) | false
        new Moves(4, 3, 5, 7) | false
        new Moves(4, 3, 1, 4) | false
